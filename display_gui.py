...
w_king_img = pygame.image.load('images/whiteking.png')
w_queen_img = pygame.image.load('images/whitequeen.png')
w_bishop_img = pygame.image.load('images/w_bishop.png')
w_knight_img = pygame.image.load('images/whiteknight.png')
w_rook_img = pygame.image.load('images/w_rook.png')
w_pawn_img = pygame.image.load('images/whitepawn.png')
b_king_img = pygame.image.load('images/blackking.png')
b_queen_img = pygame.image.load('images/blackqueen.png')
b_bishop_img = pygame.image.load('images/blackbishop.png')
b_knight_img = pygame.image.load('images/blackknight.png')
b_rook_img = pygame.image.load('images/b_rook.png')
b_pawn_img = pygame.image.load('images/blackpawn.png')
