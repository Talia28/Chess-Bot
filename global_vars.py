...
ID_TECH_LOGO = pygame.image.load('logos/Chess_Logo.jpg')

# Board Colors
LIGHT_COLOR = pygame.Color('#F0E6ED')
DARK_COLOR = pygame.Color('#F0B8E0')
LABEL_COLOR = pygame.Color('#CCCEF6')
BORDER_COLOR = pygame.Color('#CCCEF6')
L_SELECT_COLOR = pygame.Color(226, 227, 240)
D_SELECT_COLOR = pygame.Color(204, 206, 246)
